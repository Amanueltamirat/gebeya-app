...
function footer() {
  return (
      <div className="footer-container bg-purple-700">
        <div className="footer mx-10 flex justify-between items-center py-10">
            <div className="svg">
            ...
            <div className="footer-dropdown flex text-white gap-10">
                <div className="div">
                    <h3 className="font-bold text-xl">About</h3>
                <div className=" dropdown cursor-pointer">
                  <div className='hidden dropbtn'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4" color="white" >
        ...
        <div className="social mx-10 flex gap-10 pb-10 transition-all duration-300">
